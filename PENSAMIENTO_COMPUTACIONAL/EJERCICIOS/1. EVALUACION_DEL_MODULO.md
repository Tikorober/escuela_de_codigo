...
1. Menciona al menos 3 tipos de datos que existen: (valor 0.4)
    ...
    Respuesta: Numerico, Logicos, Booleanos
...
Indica que tipo de variable es en cada caso: (valor 0.3 por cada uno)
                                           ...
                                           Tipo de variable
    11. iva = 0.15                         flotante

    12. letra = ‘a’                        caracter unico

    13. suma = a + b/ c                    flotante
    ...
    17. suma = suma + num                 flotante

    18. c = sqrt(a*a + b*b)               flotante
